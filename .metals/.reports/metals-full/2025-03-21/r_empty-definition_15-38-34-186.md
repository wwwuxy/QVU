error id: pvu/FracNorm#DECIMAL_POINT.
file://<WORKSPACE>/src/main/scala/pvu/FracNorm.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol pvu/FracNorm#DECIMAL_POINT.
