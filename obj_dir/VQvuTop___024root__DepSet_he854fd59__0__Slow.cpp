...
VL_ATTR_COLD void VQvuTop___024root___eval_initial(VQvuTop___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VQvuTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQvuTop___024root___eval_initial\n"); );
    // Body
    VQvuTop___024root___eval_initial__TOP(vlSelf);
...
VL_ATTR_COLD void VQvuTop___024root___dump_triggers__stl(VQvuTop___024root* vlSelf) {
    ...
    if (vlSelf->__VstlTriggered.at(1U)) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(2U)) {
        VL_DBG_MSGF("         'stl' region trigger index 2 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(3U)) {
        VL_DBG_MSGF("         'stl' region trigger index 3 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(4U)) {
        VL_DBG_MSGF("         'stl' region trigger index 4 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(5U)) {
        VL_DBG_MSGF("         'stl' region trigger index 5 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(6U)) {
        VL_DBG_MSGF("         'stl' region trigger index 6 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(7U)) {
        VL_DBG_MSGF("         'stl' region trigger index 7 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(8U)) {
        VL_DBG_MSGF("         'stl' region trigger index 8 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(9U)) {
        VL_DBG_MSGF("         'stl' region trigger index 9 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(0xaU)) {
        VL_DBG_MSGF("         'stl' region trigger index 10 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(0xbU)) {
        VL_DBG_MSGF("         'stl' region trigger index 11 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(0xcU)) {
        VL_DBG_MSGF("         'stl' region trigger index 12 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(0xdU)) {
        VL_DBG_MSGF("         'stl' region trigger index 13 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(0xeU)) {
        VL_DBG_MSGF("         'stl' region trigger index 14 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(0xfU)) {
        VL_DBG_MSGF("         'stl' region trigger index 15 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VstlTriggered.at(0x10U)) {
        VL_DBG_MSGF("         'stl' region trigger index 16 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VQvuTop___024root___eval_stl(VQvuTop___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VQvuTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQvuTop___024root___eval_stl\n"); );
    // Body
    if (vlSelf->__VstlTriggered.at(0U)) {
...
VL_ATTR_COLD void VQvuTop___024root___dump_triggers__ico(VQvuTop___024root* vlSelf) {
    ...
    if (vlSelf->__VicoTriggered.at(1U)) {
        VL_DBG_MSGF("         'ico' region trigger index 1 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(2U)) {
        VL_DBG_MSGF("         'ico' region trigger index 2 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(3U)) {
        VL_DBG_MSGF("         'ico' region trigger index 3 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(4U)) {
        VL_DBG_MSGF("         'ico' region trigger index 4 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(5U)) {
        VL_DBG_MSGF("         'ico' region trigger index 5 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(6U)) {
        VL_DBG_MSGF("         'ico' region trigger index 6 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(7U)) {
        VL_DBG_MSGF("         'ico' region trigger index 7 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(8U)) {
        VL_DBG_MSGF("         'ico' region trigger index 8 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(9U)) {
        VL_DBG_MSGF("         'ico' region trigger index 9 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(0xaU)) {
        VL_DBG_MSGF("         'ico' region trigger index 10 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(0xbU)) {
        VL_DBG_MSGF("         'ico' region trigger index 11 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(0xcU)) {
        VL_DBG_MSGF("         'ico' region trigger index 12 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(0xdU)) {
        VL_DBG_MSGF("         'ico' region trigger index 13 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(0xeU)) {
        VL_DBG_MSGF("         'ico' region trigger index 14 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(0xfU)) {
        VL_DBG_MSGF("         'ico' region trigger index 15 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VicoTriggered.at(0x10U)) {
        VL_DBG_MSGF("         'ico' region trigger index 16 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VQvuTop___024root___dump_triggers__act(VQvuTop___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(3U)) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(4U)) {
        VL_DBG_MSGF("         'act' region trigger index 4 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(5U)) {
        VL_DBG_MSGF("         'act' region trigger index 5 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(6U)) {
        VL_DBG_MSGF("         'act' region trigger index 6 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(7U)) {
        VL_DBG_MSGF("         'act' region trigger index 7 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(8U)) {
        VL_DBG_MSGF("         'act' region trigger index 8 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(9U)) {
        VL_DBG_MSGF("         'act' region trigger index 9 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(0xaU)) {
        VL_DBG_MSGF("         'act' region trigger index 10 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(0xbU)) {
        VL_DBG_MSGF("         'act' region trigger index 11 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(0xcU)) {
        VL_DBG_MSGF("         'act' region trigger index 12 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(0xdU)) {
        VL_DBG_MSGF("         'act' region trigger index 13 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(0xeU)) {
        VL_DBG_MSGF("         'act' region trigger index 14 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VactTriggered.at(0xfU)) {
        VL_DBG_MSGF("         'act' region trigger index 15 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
...
VL_ATTR_COLD void VQvuTop___024root___dump_triggers__nba(VQvuTop___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([hybrid] QvuTop.decode1.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(3U)) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([hybrid] QvuTop.decode1.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(4U)) {
        VL_DBG_MSGF("         'nba' region trigger index 4 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(5U)) {
        VL_DBG_MSGF("         'nba' region trigger index 5 is active: @([hybrid] QvuTop.decode1.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(6U)) {
        VL_DBG_MSGF("         'nba' region trigger index 6 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(7U)) {
        VL_DBG_MSGF("         'nba' region trigger index 7 is active: @([hybrid] QvuTop.decode1.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(8U)) {
        VL_DBG_MSGF("         'nba' region trigger index 8 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(9U)) {
        VL_DBG_MSGF("         'nba' region trigger index 9 is active: @([hybrid] QvuTop.decode2.lzcModule.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(0xaU)) {
        VL_DBG_MSGF("         'nba' region trigger index 10 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(0xbU)) {
        VL_DBG_MSGF("         'nba' region trigger index 11 is active: @([hybrid] QvuTop.decode2.lzcModule_1.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(0xcU)) {
        VL_DBG_MSGF("         'nba' region trigger index 12 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(0xdU)) {
        VL_DBG_MSGF("         'nba' region trigger index 13 is active: @([hybrid] QvuTop.decode2.lzcModule_2.gen_lzc.sel_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(0xeU)) {
        VL_DBG_MSGF("         'nba' region trigger index 14 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes or [hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.index_nodes)\n");
    }
    if (vlSelf->__VnbaTriggered.at(0xfU)) {
        VL_DBG_MSGF("         'nba' region trigger index 15 is active: @([hybrid] QvuTop.decode2.lzcModule_3.gen_lzc.sel_nodes)\n");
    }
...
VL_ATTR_COLD void VQvuTop___024root___ctor_var_reset(VQvuTop___024root* vlSelf) {
    ...
    vlSelf->QvuTop__DOT____VdfgTmp_ha10fc7a1__0 = 0;
    vlSelf->QvuTop__DOT____VdfgTmp_hbe60a94c__0 = 0;
    vlSelf->QvuTop__DOT____VdfgTmp_hf2aa9257__0 = 0;
    vlSelf->QvuTop__DOT____VdfgTmp_h4c27362e__0 = 0;
    vlSelf->QvuTop__DOT____VdfgTmp_hf04f431a__0 = 0;
    vlSelf->QvuTop__DOT__decode1__DOT__isNaR = VL_RAND_RESET_I(4);
    vlSelf->QvuTop__DOT__decode1__DOT___barrel_shifter_3_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT___barrel_shifter_2_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT___barrel_shifter_1_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT___barrel_shifter_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT___operand_0_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT___operand_1_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT___operand_2_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT___operand_3_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT____Vcellinp__lzcModule__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT____Vcellinp__lzcModule_1__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT____Vcellinp__lzcModule_2__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT____Vcellinp__lzcModule_3__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT____VdfgTmp_h21c2c097__0 = 0;
    vlSelf->QvuTop__DOT__decode1__DOT____VdfgTmp_h217d4d15__0 = 0;
    vlSelf->QvuTop__DOT__decode1__DOT____VdfgTmp_h24cba9c4__0 = 0;
    vlSelf->QvuTop__DOT__decode1__DOT____VdfgTmp_h244a7236__0 = 0;
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode1__DOT__lzcModule__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_1__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_1__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_1__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_2__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_2__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_2__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_3__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_3__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode1__DOT__lzcModule_3__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT__io_Exp = VL_RAND_RESET_I(32);
    vlSelf->QvuTop__DOT__decode2__DOT__isNaR = VL_RAND_RESET_I(4);
    vlSelf->QvuTop__DOT__decode2__DOT___barrel_shifter_3_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT___barrel_shifter_2_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT___barrel_shifter_1_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT___barrel_shifter_io_result_o = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT___operand_0_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT___operand_1_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT___operand_2_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT___operand_3_T_6 = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT____Vcellinp__lzcModule__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT____Vcellinp__lzcModule_1__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT____Vcellinp__lzcModule_2__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT____Vcellinp__lzcModule_3__in_i = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT____VdfgTmp_h21c2c097__0 = 0;
    vlSelf->QvuTop__DOT__decode2__DOT____VdfgTmp_h217d4d15__0 = 0;
    vlSelf->QvuTop__DOT__decode2__DOT____VdfgTmp_h24cba9c4__0 = 0;
    vlSelf->QvuTop__DOT__decode2__DOT____VdfgTmp_h244a7236__0 = 0;
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode2__DOT__lzcModule__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_1__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_1__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_1__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_2__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_2__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_2__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_3__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_3__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->QvuTop__DOT__decode2__DOT__lzcModule_3__DOT__gen_lzc__DOT__in_tmp = VL_RAND_RESET_I(31);
    vlSelf->QvuTop__DOT__floatDecode1__DOT___GEN = VL_RAND_RESET_I(4);
    vlSelf->QvuTop__DOT__floatDecode1__DOT___GEN_0 = VL_RAND_RESET_I(4);
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h8a383c23__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h898ddcf9__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h8933512e__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h88bc2594__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h8929cb16__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h89ab41bc__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h8a58f023__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode1__DOT____VdfgTmp_h8aa26e89__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT___GEN = VL_RAND_RESET_I(4);
    vlSelf->QvuTop__DOT__floatDecode2__DOT___GEN_0 = VL_RAND_RESET_I(4);
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h8a383c23__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h898ddcf9__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h8933512e__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h88bc2594__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h8929cb16__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h89ab41bc__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h8a58f023__0 = 0;
    vlSelf->QvuTop__DOT__floatDecode2__DOT____VdfgTmp_h8aa26e89__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__globalMax = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__globalMin = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__globalScale = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__globalOffset = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__batchMax = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__batchMin = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__batchHasData = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftVal = VL_RAND_RESET_I(6);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftedFrac = VL_RAND_RESET_I(32);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_0 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_1 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftVal_1 = VL_RAND_RESET_I(6);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftedFrac_1 = VL_RAND_RESET_I(32);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_3 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_4 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftVal_2 = VL_RAND_RESET_I(6);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftedFrac_2 = VL_RAND_RESET_I(32);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_6 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_7 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftVal_3 = VL_RAND_RESET_I(6);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__shiftedFrac_3 = VL_RAND_RESET_I(32);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_9 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_10 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_11 = VL_RAND_RESET_Q(34);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__remainder = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___GEN_12 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__needRounding = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___roundedValue_T_4 = VL_RAND_RESET_Q(34);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__remainder_1 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__needRounding_1 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___roundedValue_T_10 = VL_RAND_RESET_Q(34);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__remainder_2 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__needRounding_2 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___roundedValue_T_16 = VL_RAND_RESET_Q(34);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__remainder_3 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__needRounding_3 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT___roundedValue_T_22 = VL_RAND_RESET_Q(34);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT___GEN_14 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT___GEN_15 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT___GEN_16 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT___GEN_17 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT___GEN_18 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT___GEN_19 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT__unnamedblk2__DOT___range_T = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT__unnamedblk2__DOT___range_T_7 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_20 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_21 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT__unnamedblk2__DOT___mid_T = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT__unnamedblk1__DOT__unnamedblk2__DOT___mid_T_3 = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hdf96a6fc__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hdf96a634__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hdcaf2b43__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hdcaf4442__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hd95c8805__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hd95c8ec3__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hd9d61bde__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_hd9d61d93__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_h8d89f6e8__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_h421836e6__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_h44fc25d8__0 = 0;
    vlSelf->QvuTop__DOT__quantizeInt8__DOT____VdfgTmp_h964749d0__0 = 0;
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT___GEN_12 = VL_RAND_RESET_Q(34);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT___GEN_14 = VL_RAND_RESET_Q(37);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT___GEN_15 = VL_RAND_RESET_Q(33);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_17 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_18 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_19 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_20 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_21 = VL_RAND_RESET_I(1);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_22 = VL_RAND_RESET_I(23);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_23 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_24 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_25 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_26 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_27 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_28 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_29 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_30 = VL_RAND_RESET_I(23);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___dataRange_T = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT__binWidth_4 = VL_RAND_RESET_Q(33);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT___GEN_31 = VL_RAND_RESET_I(1);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT__unnamedblk2__DOT___GEN_32 = VL_RAND_RESET_I(1);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT__unnamedblk2__DOT___mid_T = VL_RAND_RESET_Q(33);
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT__unnamedblk3__DOT___GEN_33 = VL_RAND_RESET_I(1);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT__unnamedblk3__DOT___GEN_34 = VL_RAND_RESET_I(1);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT__unnamedblk3__DOT___GEN_35 = VL_RAND_RESET_I(1);
    ...
    vlSelf->QvuTop__DOT__quantizeInt4__DOT__unnamedblk1__DOT__unnamedblk3__DOT___GEN_36 = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode1__DOT__lzcModule_1__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode1__DOT__lzcModule_1__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode1__DOT__lzcModule_2__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode1__DOT__lzcModule_2__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode1__DOT__lzcModule_3__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode1__DOT__lzcModule_3__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule_1__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule_1__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule_2__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule_2__DOT__gen_lzc__DOT__index_nodes);
    vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule_3__DOT__gen_lzc__DOT__sel_nodes = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(160, vlSelf->__Vtrigrprev__TOP__QvuTop__DOT__decode2__DOT__lzcModule_3__DOT__gen_lzc__DOT__index_nodes);
