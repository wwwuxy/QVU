...
const char* FLOAT_INPUT_FILE      = "./test_src/EfficientNet/efficientnet_sampled_activations.txt";    
const char* FP4_RESULTS_FILE      = "./test_src/EfficientNet/fp4_results.bin";    // FP4结果文件
