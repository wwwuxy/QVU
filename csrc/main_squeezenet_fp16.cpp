#include"../config.h"
#ifdef CONFIG_SQUEEZENET_FP16

/**
 * SqueezeNet Posit32到FP16量化测试程序
 * 
 * 程序功能:
...
const char* POSIT_INPUT_FILE      = "./test_src/SqueezeNet/posit_activations.bin";
const char* FLOAT_INPUT_FILE      = "./test_src/SqueezeNet/squeezenet_sampled_activations.txt";    // 浮点数输入文件
const char* FP16_RESULTS_FILE     = "./test_src/SqueezeNet/fp16_results.bin";    // FP16结果文件
