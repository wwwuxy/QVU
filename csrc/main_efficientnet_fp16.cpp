#include"../config.h"
#ifdef CONFIG_EFFICIENTNET_FP16
...
const char* POSIT_INPUT_FILE      = "./test_src/EfficientNet/posit_activations.bin";
const char* FLOAT_INPUT_FILE      = "./test_src/EfficientNet/efficientnet_sampled_activations.txt";    // 浮点数输入文件
const char* FP16_RESULTS_FILE     = "./test_src/EfficientNet/fp16_results.bin";    // FP16结果文件
