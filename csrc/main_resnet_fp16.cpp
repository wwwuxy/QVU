...
const char* POSIT_INPUT_FILE      = "./test_src/ResNet50/posit_activations.bin";
const char* FLOAT_INPUT_FILE      = "./test_src/ResNet50/resnet_sampled_activations.txt";    // 浮点数输入文件
const char* FP16_RESULTS_FILE     = "./test_src/ResNet50/fp16_results.bin";    // FP16结果文件
