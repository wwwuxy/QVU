...
const char* FLOAT_INPUT_FILE      = "./test_src/RegNet/regnet_sampled_activations.txt";    // 浮点数输入文件
const char* FP16_RESULTS_FILE     = "./test_src/RegNet/fp16_results.bin";    // FP16结果文件
