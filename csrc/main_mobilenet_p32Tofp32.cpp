#include"../config.h"
#ifdef CONFIG_MOBILENET_POSIT32_TO_FP32
...
const char* POSIT_FILE   = "./test_src/MobileNet/posit32_data.bin";
const char* GOLDEN_FILE  = "./test_src/MobileNet/fp32_data.bin";
