...
const char* FLOAT_INPUT_FILE      = "./test_src/SqueezeNet/squeezenet_sampled_activations.txt";    
const char* FP4_RESULTS_FILE      = "./test_src/SqueezeNet/fp4_results.bin";    // FP4结果文件
