...
const char* FLOAT_INPUT_FILE      = "./test_src/ConvNeXt/convnext_sampled_activations.txt";    
const char* FP4_RESULTS_FILE      = "./test_src/ConvNeXt/fp4_results.bin";    // FP4结果文件
