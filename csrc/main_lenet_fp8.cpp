...
const char* POSIT_INPUT_FILE      = "./test_src/LeNet5/posit_activations.bin";
const char* FLOAT_INPUT_FILE      = "./test_src/LeNet5/lenet_sampled_activations.txt";
const char* FP8_RESULTS_FILE      = "./test_src/LeNet5/fp8_results.bin";
