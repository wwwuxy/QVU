#include"../config.h"
#ifdef CONFIG_EFFICIENTNET_FP32_TO_POSIT32
...
const char* FP32_FILE     = "./test_src/EfficientNet/fp32_data.bin";
const char* GOLDEN_FILE   = "./test_src/EfficientNet/posit32_data.bin";
