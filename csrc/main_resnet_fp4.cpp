...
const char* FLOAT_INPUT_FILE      = "./test_src/ResNet50/resnet_sampled_activations.txt";    
const char* FP4_RESULTS_FILE      = "./test_src/ResNet50/fp4_results.bin";    // FP4结果文件
