 ...
 */
 ...
 const char* FLOAT_INPUT_FILE      = "./test_src/VGG16/resnet_sampled_activations.txt";
 const char* FP8_RESULTS_FILE      = "./test_src/VGG16/fp8_results.bin";
