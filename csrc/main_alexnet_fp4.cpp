...
const char* FLOAT_INPUT_FILE      = "./test_src/AlexNet/alexnet_sampled_activations.txt";    
const char* FP4_RESULTS_FILE      = "./test_src/AlexNet/fp4_results.bin";    // FP4结果文件
