#include"../config.h"
#ifdef CONFIG_RESNET_GREATER_P32
...
//---------------- 配置参数 -------------------
#define OP   8   // Greater操作的操作码
const char* ACT_FILE      = "./test_src/posit_greater_act.bin";
const char* WEIGHT_FILE   = "./test_src/posit_greater_weight.bin";
