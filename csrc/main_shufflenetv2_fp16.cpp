#include"../config.h"
#ifdef CONFIG_SHUFFLENETV2_FP16
...
const char* POSIT_INPUT_FILE      = "./test_src/ShuffleNetV2/posit_activations.bin";
const char* FLOAT_INPUT_FILE      = "./test_src/ShuffleNetV2/shufflenetv2_sampled_activations.txt";    // 浮点数输入文件
const char* FP16_RESULTS_FILE     = "./test_src/ShuffleNetV2/fp16_results.bin";    // FP16结果文件
