#include"../config.h"
#ifdef CONFIG_EFFICIENTNET_POSIT32_TO_FP32
...
const char* POSIT_FILE   = "./test_src/EfficientNet/posit32_data.bin";
const char* GOLDEN_FILE  = "./test_src/EfficientNet/fp32_data.bin";
