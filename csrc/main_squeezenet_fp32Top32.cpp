#include"../config.h"
#ifdef CONFIG_SQUEEZENET_FP32_TO_POSIT32
...
const char* FP32_FILE     = "./test_src/SqueezeNet/fp32_data.bin";
const char* GOLDEN_FILE   = "./test_src/SqueezeNet/posit32_data.bin";
