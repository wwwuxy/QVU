#include"../config.h"
#ifdef CONFIG_SQUEEZENET_POSIT32_TO_FP32
...
const char* POSIT_FILE   = "./test_src/SqueezeNet/posit32_data.bin";
const char* GOLDEN_FILE  = "./test_src/SqueezeNet/fp32_data.bin";
